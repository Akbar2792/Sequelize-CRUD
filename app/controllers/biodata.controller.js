    ...
    biodata
        ...
        .then((data) => {
            if (data === null) {
                res
                    .status(404)
                    .send({message: 'Profile pesilat not found'});
            } else {
                res.send(data);
            }
        })
        ...
        .then((result) => {
            ...
            if (result[0] === 1) {
                if (!req.body.nama || !req.body.tempatLahir || !req.body.tanggalLahir || !req.body.alamat) {
                    ...
                    res.send({message: 'Profile pesilat updated successfully.', data: req.body});
                }
            } else {
                res
                    .status(404)
...
exports.patch = (req, res) => {
    biodata
        ...
        .then((data) => {
            ...
            res.send({message: 'Profile pesilat updated successfully.', data: data});
        })
        .catch((err) => {
            res
                .status(500)
...
exports.delete = (req, res) => {
    biodata
        ...
        .then((result) => {
            console.log(result);
            if (result === 1) {
                res.send({message: 'Profile pesilat deleted successfully.'});
            } else {
                res
                    .status(404)
                    .send({message: 'Profile pesilat not found!'});
